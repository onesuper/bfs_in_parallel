...
# test the correctness of bitmap

#./bitmap ../../test_case/tiny_graph 6
...
#./bitmap ../../test_case/regular/RGL5 $i
#./bitmap ../../test_case/regular/RGL6 $i
...
#./bitmap ../../test_case/irregular/IRGL5 $i
#./bitmap ../../test_case/irregular/IRGL6 $i
...
#./bitmap ../../test_case/real_graph/CAL $i
#./bitmap ../../test_case/real_graph/NE $i
#./bitmap ../../test_case/real_graph/NW $i
#./bitmap ../../test_case/real_graph/LKS $i
...
#./bitmap ../../test_case/small_world/SW5 $i
#./bitmap ../../test_case/small_world/SW6 $i
