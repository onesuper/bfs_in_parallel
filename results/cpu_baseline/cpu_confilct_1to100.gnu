...
set output 'cpu_conflict_1to100.png'

set datafile missing '-'
set style data linespoints
set title "CPU Conflict with Changing Thread Number"
...
plot 'cpu_conflict_1to100.dat' using 2 t "RGL1", '' using 3 t "IRGL1", '' using 4 t "BAY", '' using 5 t "SW1" 
